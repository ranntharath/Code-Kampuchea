        ...
        <div className="relative max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              <button className="bg-white text-primary-color font-bold text-lg px-10 py-5 rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300">
                ចុះឈ្មោះឥឡូវនេះ
              </button>
